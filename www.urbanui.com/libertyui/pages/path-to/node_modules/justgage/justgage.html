...
<script type='text/javascript'>
/* <![CDATA[ */
var ajax_auth_object = {"ajaxurl":"https:\/\/www.urbanui.com\/wp-admin\/admin-ajax.php","redirecturl":"\/libertyui\/pages\/path-to\/node_modules\/justgage\/justgage.js","loadingmessage":"Please wait..."};
/* ]]> */
</script>
...
<meta name="msapplication-TileImage" content="https://www.urbanui.com/wp-content/uploads/2019/05/cropped-favicon-270x270.png" />
	...
	<body> 
		...
		<h2>Log In</h2>
		<p class="bd-notice"></p>
		<input type="hidden" id="security" name="security" value="c96ac76dbb" /><input type="hidden" name="_wp_http_referer" value="/libertyui/pages/path-to/node_modules/justgage/justgage.js" />  
		<div>
  ...
  <div class="modal lrp-modal" id="regpopup" >
		...
		<h2>Register</h2>
		<p class="bd-notice"></p>
	  <input type="hidden" id="signonsecurity" name="signonsecurity" value="1a40dbe913" /><input type="hidden" name="_wp_http_referer" value="/libertyui/pages/path-to/node_modules/justgage/justgage.js" />   
    ...
    <p class="bd-notice"></p>  
    <input type="hidden" id="forgotsecurity" name="forgotsecurity" value="fdc3c82721" /><input type="hidden" name="_wp_http_referer" value="/libertyui/pages/path-to/node_modules/justgage/justgage.js" />  
